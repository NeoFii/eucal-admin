...
const METRIC_CONFIG: Record<TrendMetric, { label: string; unit: string; dataKey: MetricDataKey }> = {
    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (params: unknown) => {
          ...
          const hoveredTimestamp = getTooltipTimestamp(items[0]);
          const matchedRows = buildTooltipRows(trendData.providers, metricCfg.dataKey, hoveredTimestamp);
          const headerLabel =
            items[0]?.axisValueLabel ??
            (hoveredTimestamp != null ? formatTooltipDateTime(hoveredTimestamp) : undefined);
